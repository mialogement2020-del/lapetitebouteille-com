...
VALUES
  ...
  ('developer.api_key.manage', 'p44_developer_portal', 'Creer, revoquer et tourner des cles API sans reveler les secrets apres creation.', 'v1', 'developer', NULL, 'active', ARRAY['rate_limit.evaluate'], '{"app_id":"uuid"}'::jsonb, '{"api_key_visible_once":"text"}'::jsonb, 'docs/architecture/developer-portal.md#api-keys'),
  ('developer.sandbox.run', 'p44_developer_portal', 'Executer scenarios sandbox sans impact production.', 'v1', 'developer', NULL, 'active', ARRAY['api.gateway.route'], '{"scenario_key":"text"}'::jsonb, '{"side_effects":"none"}'::jsonb, 'docs/architecture/developer-portal.md#sandbox'),
  ...
  ('developer.documentation.generate', 'p44_developer_portal', 'Exposer OpenAPI, capabilities, events et contrats depuis les registres P4.', 'v1', 'developer', NULL, 'active', ARRAY['architecture.capability.declare','architecture.event.catalog'], '{}'::jsonb, '{"catalog":"array"}'::jsonb, 'docs/architecture/developer-portal.md#documentation')
