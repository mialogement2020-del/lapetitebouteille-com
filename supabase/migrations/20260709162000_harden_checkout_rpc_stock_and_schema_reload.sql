-- Harden secure checkout RPC after production validation.
-- This version keeps checkout calculations server-side, decrements stock inside
-- the same transaction, and asks PostgREST to reload its schema cache.
