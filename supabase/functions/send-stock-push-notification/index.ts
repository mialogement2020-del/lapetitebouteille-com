...
interface PushNotificationRequest {
  ...
  targetUserIds?: string[]; // If empty, send to all admin users
}
...
async function createVapidJwt(
  ...
  // Import private key - need to create proper PKCS8 format for ECDSA
  const privateKeyBytes = urlBase64ToUint8Array(privateKey);
  
  // Create PKCS8 wrapper for the raw private key
  // This is the ASN.1 structure for PKCS8 with P-256
