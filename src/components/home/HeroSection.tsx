  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-noir">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?q=80&w=2070')`,
        }}
      >
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-primary">Collection Premium 2024</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="font-display text-4xl md:text-5xl lg:text-7xl font-bold text-cream leading-tight mb-6"
          >
            L'Excellence des Vins
            <br />
            <span className="text-gradient-gold">livrée chez vous</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-cream/80 mb-10 max-w-2xl mx-auto leading-relaxed"
          >
            Découvrez notre sélection exclusive de vins, champagnes et spiritueux. 
            Livraison express à Yaoundé et Douala.
          </motion.p>
          ...
          >
            <Button
              asChild
              size="lg"
              className="bg-gradient-gold text-noir font-semibold text-lg px-8 py-6 hover:opacity-90 shadow-gold"
            >
              <Link to="/catalogue">
